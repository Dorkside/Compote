...
class NoteSyncManager {
    static func fetchNotesContent(notesContent: inout [Note], syncItem: NSMenuItem?) {
        notesContent.removeAll()
                    ...
                    if output.descriptorType != typeNull {
                        ...
                        for i in 1...listDescriptor.numberOfItems {
                            ...
                            DispatchQueue.main.asyncAfter(deadline: .now() + 5) {
                                ...
                                NotificationManager.scheduleNotification(title: "Sync done", body: "Successfully synced \(notesContent.count) notes", delay: 1)
